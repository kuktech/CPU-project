...
if(t3) begin
    ...
    `GRP_ARITH: begin
        ...
        `AR_ADDC: begin
            ...
            alu_result0 = temp[15:0];
            alu_cf = temp[16];
            alu_hf = (l_operand[3:0] + r_operand[3:0] + alu_cf_in) > 4'hF;
            alu_vf = (~(l_operand[15] ^ r_operand[15])) & (l_operand[15] ^ alu_result0[15]);
            alu_nf = alu_result0[15];
            alu_zf = (alu_result0 == 16'b0);
            alu_sf = 1'b0;
        ...
        `AR_SUB: begin
            ...
            alu_result0 = temp[15:0];
            alu_cf = temp[16];
            alu_hf = (l_operand[3:0] < r_operand[3:0]);
            alu_vf = (l_operand[15] ^ r_operand[15]) & (l_operand[15] ^ alu_result0[15]);
            alu_nf = alu_result0[15];
            alu_zf = (alu_result0 == 16'b0);
            alu_sf = 1'b0;
    ...
    `GRP_CMP: begin
        ...
        alu_result0 = temp[15:0];
        alu_zf  = (alu_result0 == 16'b0);
        alu_gtf = (~alu_result0[15]) & (~alu_zf);
        alu_ltf = alu_result0[15];
    end
